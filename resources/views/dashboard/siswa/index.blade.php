        ...
        <div class="card mb-4">
          ...
          <div class="card-header pb-0 d-flex justify-content-between">
            <div class="input-group" style="width: 25%;">
              <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="/dataSiswa/search" method="GET">
                <input type="search" name="search" class="form-control" placeholder="Cari NISN ..." autofocus>
              </form>
            </div>
            <div>
              <a href="/dataSiswa/create" class="btn btn-sm mb-0 me-1 btn-success">Create</a>
            </div>
          </div>
                    ...
                    <tr>
                      ...
                      <td class="text-xs font-weight-bolder opacity-7">
                        <form action="{{ route('dataSiswa.destroy',$row->id) }}" method="POST">
                          <a href="{{ route('dataSiswa.edit', $row->id) }}" class="btn btn-sm mb-0 me-1 btn-warning">Edit</a>
                          @csrf
                          @method('DELETE')
